(function () {
    ...
    function createMap() {
        ...
        var point = new BMap.Point(114.463462, 22.794721);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{ title: "惠州市惠阳区", content: "我的备注", point: "114.439028|22.776062", isOpen: 0, icon: { w: 21, h: 21, l: 0, t: 0, x: 6, lb: 5 } }
    ];
    //创建marker
    function addMarker() {
